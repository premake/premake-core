...
--
	...
	function suite.dependson_createsOrderOnlyDependency()
		...
		test.capture [[
build bin/Debug/ProjectB: link obj/Debug/ProjectB/b.o | bin/Debug/ProjectA
...
--
	...
	function suite.dependson_worksWithLinks()
		...
		test.capture [[
build bin/Debug/App: link obj/Debug/App/app.o | bin/Debug/libLibraryA.a bin/Debug/libLibraryB.a
