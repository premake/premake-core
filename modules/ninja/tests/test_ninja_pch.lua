...
--
	...
	function suite.perFileNoPCH_noInclude()
		...
		test.capture [[
build obj/Debug/nopch.o: cxx nopch.cpp
...
--
	...
	function suite.perFileWithPCH_hasInclude()
		...
		test.capture [[
build obj/Debug/main.o: cxx main.cpp | obj/Debug/pch.h.gch
...
--
	...
	function suite.sourceFile_hasYuFlag_MSVC()
		...
		test.capture [[
build obj/Debug/main.obj: cxx main.cpp | obj/Debug/stdafx.pch
